...
Veja o arquivo sample_dados_consolidados.csv para a estrutura completa com 30 linhas de exemplo cobrindo o período inteiro (2020-2026).
...
⚙️ Como funciona
Leitura: Lê todos os 150+ arquivos Excel das 3 lojas
Limpeza: Padroniza nomes de colunas, tipos de dados e formatos
Preenchimento: Auditado de códigos de cliente em branco (mantendo rastreabilidade)
Consolidação: Merge em uma única tabela de 86.134 linhas
